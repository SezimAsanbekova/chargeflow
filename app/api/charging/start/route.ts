...
export async function POST(request: Request) {
  try {
    ...
    // Проверяем баланс (должно быть достаточно для депозита + минимум 1 минута)
    const minimumBalance = depositAmount + pricePerMinute;
    ...
    // Создаем сессию зарядки и списываем депозит в транзакции
