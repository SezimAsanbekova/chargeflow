...
import { AlertCircle, Clock, Battery, DollarSign, CreditCard, Home } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#0a1f1a] pb-20">
      ...
      <div className="bg-gradient-to-b from-red-600 to-red-500 text-white p-8 text-center">
        ...
        <h1 className="text-2xl font-bold mb-2">Зарядка остановлена</h1>
        <p className="text-red-100 text-sm">Недостаточно средств на балансе</p>
      </div>
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="bg-[#0f2820] rounded-lg p-4">
          <div className="text-gray-400 text-sm mb-1">Станция</div>
        ...
        <div className="bg-red-900/30 border border-red-500/50 rounded-lg p-4">
          <div className="flex justify-between items-center">
            <span className="text-red-300">Баланс</span>
